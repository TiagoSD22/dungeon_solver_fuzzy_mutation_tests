...
public class MatrixFuzzTest {
    ...
    @Fuzz
    public void fuzzMatrixInput(@From(RandomJsonGenerator.class) String input) throws Exception {
    ...
    @Fuzz
    public void fuzzValidDungeonInput(@From(RectIntMatrixGenerator.class) int[][] grid) throws Exception {
    ...
    @Fuzz
    public void fuzzRawJsonBody(@From(RandomJsonGenerator.class) String body) throws Exception {
        RestTemplate restTemplate = new RestTemplate();
        String url = "http://localhost:8080/api/dungeon/solve";
    ...
    @Fuzz
    public void fuzzMalformedJsonBody(@From(MalformedJsonGenerator.class) String body) throws Exception {
